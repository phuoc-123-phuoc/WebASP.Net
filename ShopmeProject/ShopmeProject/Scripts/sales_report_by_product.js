...
$(document).ready(function() {
	...
	//$("#buttonViewReportByDateRange" + "_product").on("click", function (e) {

	//	ValidateDateRange("_product", LoadSalesReportByDateForProduct);
	//	//LoadSalesReportByDateForProduct("custom");
	//});
});
