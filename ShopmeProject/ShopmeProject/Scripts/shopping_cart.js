...
function updateTotal() {
	...
	$(".subtotal").each(function (index, element) {
		productCount++;
		total += parseFloat(clearCurrencyFormat(element.innerHTML.replace(currencySymbol, "")));
	});
...
function formatCurrency(amount) {
	return formatPrice(currencySymbol, currencySymbolPosition, amount, thousandsPointType, decimalDigits, decimalPointType);
}
